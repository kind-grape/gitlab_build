...
1. A Kubernetes cluster, version 1.12 or higher. 8vCPU and 30GB of RAM is recommended.
...
with Helm v2, please see the [Helm migration](migration/helm.md) documentation.
